...
ig.module("game.entities.songs-data").requires("impact.entity").defines(function() {
	EntitySongsData = ig.Entity.extend({
		...
		data: [{
			...
			title: _STRINGS.Songs[0],
			difficulty: 1,
			musicPath: "media/audio/song/song-1",
			chordData: [{
					time: 1368,
					type: 1
				}, {
...
if([ig.game.selectedSongId] == 0 && ig.game.totalScore > 600) {
 x1 = 1;
...
if([ig.game.selectedSongId] == 2 && ig.game.totalScore > 700) {
 x3 = 1;
alert("3نجحت انتقل الى الأغنية التالية")}

		
if([ig.game.selectedSongId] == 3 && ig.game.totalScore > 800) {
 x4 = 1;
...
if([ig.game.selectedSongId] == 5 && ig.game.totalScore > 900) {
 x6 = 1;
alert("6نجحت انتقل الى الأغنية التالية")}

if([ig.game.selectedSongId] == 6 && ig.game.totalScore > 1000) {
 x7 = 1;
alert("7نجحت انتقل الى الأغنية التالية")}


if([ig.game.selectedSongId] == 7 && ig.game.totalScore > 1000) {
x8 = 1;
alert("8نجحت انتقل الى الأغنية التالية")}

		
if([ig.game.selectedSongId] == 8 && ig.game.totalScore > 1000) {
 x9 = 1;
alert("9نجحت انتقل الى الأغنية التالية")}

if([ig.game.selectedSongId] == 9 && ig.game.totalScore > 1000) {
 x10 = 1;
alert("10نجحت انتقل الى الأغنية التالية")}

if([ig.game.selectedSongId] == 10 && ig.game.totalScore > 1000) {
 x11 = 1;
...
if([ig.game.selectedSongId] == 12 && ig.game.totalScore > 1000) {
x13 = 1;
